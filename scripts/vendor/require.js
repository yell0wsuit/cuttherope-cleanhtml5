...
!(function (global, setTimeout) {
    ...
    function eachProp(e, t) {
        for (var i in e) if (hasProp(e, i) && -1 == disallowedProps.indexOf(i) && t(e[i], i)) break;
    }
    ...
    function makeError(e, t, i, r) {
        ...
        return ((t.requireType = e), (t.requireModules = r), i && (t.originalError = i), t);
    }
    if (void 0 === define) {
        if (void 0 !== requirejs) {
    ...
    function newContext(u) {
        ...
        function v(e, t, i) {
            ...
            if (e) {
                ...
                for (
                    var m,
                        g = (e =
                            "." === e[0].charAt(0) && f ? f.slice(0, f.length - 1).concat(e) : e),
                        x = 0;
                    x < g.length;
                    x++
                )
            ...
            if (i && l && (f || h)) {
                ...
                (!u && d && ((u = d), (c = p)), u && (n.splice(0, c, u), (e = n.join("/"))));
            }
        ...
        function E(e) {
            ...
            return (
                ...
                isArray(t) &&
                1 < t.length &&
                (t.shift(), f.require.undef(e), f.makeRequire(null, { skipMap: !0 })([e]), 1)
            );
        }
        function w(e) {
            var t,
        ...
        function M(t, e) {
            ...
            e
                ...
                : (each(i, function (e) {
                      e = getOwn(d, e);
                      e && ((e.error = t), e.events.error) && ((r = !0), e.emit("error", t));
                  }),
                  r || req.onError(t));
        }
        function O() {
        ...
        return (
            ...
            ((e = function (e) {
                ...
                defineDep: function (e, t) {
                    this.depMatched[e] ||
                        ((this.depMatched[e] = !0), --this.depCount, (this.depExports[e] = t));
                },
                fetch: function () {
                    if (!this.fetched) {
