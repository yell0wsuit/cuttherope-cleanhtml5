define("game/Grab", [
  ...
  var Grab = CTRGameObject.extend({
        ...
        if (this.rope) {
          ...
          for (var i = 0, numPts = drawPts.length; i < numPts; i++) {
            ...
            if (
              ...
              if (this.spider.currentTimelineIndex !== SpiderState.START) {
                this.spider.rotation =
                  c3.normalizedAngle() * 57.29577951308232 + 270;
              }
    ...
    setRadius: function (radius) {
      ...
      if (radius === Constants.UNDEFINED || radius === Constants.CANDY2_FLAG) {
        ...
        this.back = ImageElement.create(
          ...
          IMG_OBJ_HOOK_AUTO_bottom,
        );
        this.back.doRestoreCutTransparency();
        this.back.anchor = this.back.parentAnchor = Alignment.CENTER;
        this.front = ImageElement.create(
          ResourceId.IMG_OBJ_HOOK_AUTO,
          IMG_OBJ_HOOK_AUTO_top,
        );
        this.front.anchor = this.front.parentAnchor = Alignment.CENTER;
        this.addChild(this.back);
        this.addChild(this.front);
      ...
      if (this.wheel) {
        ...
        this.wheelImage.anchor = this.wheelImage.parentAnchor =
          Alignment.CENTER;
        ...
        this.wheelHighlight.anchor = this.wheelHighlight.parentAnchor =
          Alignment.CENTER;
    ...
    setMoveLength: function (length, vertical, offset) {
      ...
      if (this.moveLength > 0) {
        ...
        this.moveBackground.rotationCenterX =
          -Math.round(this.moveBackground.width / 2) +
          resolution.GRAB_MOVE_BG_X_OFFSET;
    ...
    setBee: function () {
      this.bee = ImageElement.create(
        ResourceId.IMG_OBJ_BEE_HD,
        IMG_OBJ_BEE_HD_obj_bee,
      );
      ...
      wings.jumpTo(
        MathHelper.randomRange(
          0,
          IMG_OBJ_BEE_HD_wings_end - IMG_OBJ_BEE_HD_wings_start,
        ),
      );
