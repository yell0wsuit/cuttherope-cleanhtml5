define("ui/QueryStrings", [], function () {
  ...
  var QueryStrings = new (function () {
    ...
    if (false || false) {
      ...
      this.unlockAllBoxes =
        (this.box != null && this.level != null) ||
        urlContains("unlockAllBoxes=true");
      this.forcePinnedBox =
        this.unlockAllBoxes || urlContains("enablePinnedBox=true");
      this.createScoresForBox =
        qs["createScoresForBox"] == null
          ? null
          : parseInt(qs["createScoresForBox"], 10);
    }
