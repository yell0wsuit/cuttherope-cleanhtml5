  ...
  var Star = CTRGameObject.extend({
    ...
    createAnimations: function () {
      ...
      if (this.timeout > 0) {
        ...
        t = new Timeline();
        t.addKeyFrame(
          KeyFrame.makeScale(1, 1, KeyFrame.TransitionType.LINEAR, 0),
        );
        t.addKeyFrame(
          KeyFrame.makeScale(0, 0, KeyFrame.TransitionType.LINEAR, 0.25),
        );
        t.addKeyFrame(
          KeyFrame.makeColor(
            RGBAColor.solidOpaque.copy(),
      ...
      t = new Timeline();
      t.addKeyFrame(
        KeyFrame.makePos(this.x, this.y, KeyFrame.TransitionType.EASE_IN, 0),
      );
      t.addKeyFrame(
        KeyFrame.makePos(
          this.x,
      ...
      t.addKeyFrame(
        KeyFrame.makePos(this.x, this.y, KeyFrame.TransitionType.EASE_IN, 0.5),
      );
      t.addKeyFrame(
        KeyFrame.makePos(
          this.x,
