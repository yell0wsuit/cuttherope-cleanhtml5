define("game/EarthImage", [
  ...
  var EarthImage = ImageElement.extend({
    init: function (offsetX, offsetY) {
      ...
      var t = new Timeline();
      t.addKeyFrame(
        KeyFrame.makeRotation(0, KeyFrame.TransitionType.LINEAR, 0),
      );
      t.addKeyFrame(
        KeyFrame.makeRotation(180, KeyFrame.TransitionType.EASE_OUT, 0.3),
      );
      this.addTimelineWithID(t, EarthImage.TimelineId.UPSIDE_DOWN);

      var t2 = new Timeline();
      t2.addKeyFrame(
        KeyFrame.makeRotation(180, KeyFrame.TransitionType.LINEAR, 0),
      );
      t2.addKeyFrame(
        KeyFrame.makeRotation(0, KeyFrame.TransitionType.EASE_OUT, 0.3),
      );
