define("ui/EasterEggManager", [
  ...
  var EasterEggManager = function () {
    ...
    this.showDrawing = function (drawingIndex) {
      ...
      // setup the scene
      $("#dframe").animate(
        { top: resolution.uiScaledNumber(100), scale: 0.35 },
        0,
      );
      $("#dframe").fadeTo(0, 0);
    ...
    var closeDrawing = function () {
      ...
      $("#dframe").animate(
        { top: resolution.uiScaledNumber(50), scale: 0.2 },
        350,
        "easeInExpo",
      );
      $("#dmsg").animate(
      ...
      function step() {
        ...
        // move his eyes back
          ...
          if (t > s3 + 100) {
            // delay;
            l =
              10 - Easing.easeInOutExpo(t - (s3 + 100), 0, 10, s4 - (s3 + 100));
            r = l;
          }
        } else if (t < s5) {
        }
      ...
      $("#e").fadeIn(function () {
        ...
        function step() {
          ...
          // hide omnom
            ...
            sx =
              resolution.uiScaledNumber(scaleTo) -
              Easing.easeOutExpo(
                t - s5,
                0,
                resolution.uiScaledNumber(2.0),
                s1,
                s6 - s5,
              );
            sy =
