define("resources/PreLoader", [
  ...
  var loadImages = function () {
    ...
    var passwordPath =
      platform.imageBaseUrl + (editionUI.passwordDirectory || "");
    queueMenuImages(editionUI.passwordImageNames, passwordPath);

    var passwordResolutionPath =
      platform.resolutionBaseUrl +
      (editionUI.passwordResolutionDirectory || "");
    queueMenuImages(
      editionUI.passwordResolutionImageNames,
      passwordResolutionPath,
    );

    queueMenuImages(editionUI.pageImageNames, platform.imageBaseUrl + "page/");
    queueMenuImages(
      editionUI.pageResolutionImageNames,
      platform.resolutionBaseUrl + "page/",
    );
