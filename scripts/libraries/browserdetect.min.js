/* browser plugin (when feature detection is not sufficient) */
...
Modernizr.addTest("hq",function(){var a=!0;"Firefox"==BrowserDetect.browser&&(a=8<=BrowserDetect.version);"Chrome"==BrowserDetect.browser&&(a=14<=BrowserDetect.version);"Explorer"==BrowserDetect.browser&&(a=9<=BrowserDetect.version);"Opera"==BrowserDetect.browser&&(a=11.5<=BrowserDetect.version);"Safari"==BrowserDetect.browser&&(a=5<=BrowserDetect.version);return a});var isIE9OrGreater=function(){return"Explorer"==BrowserDetect.browser&&9<=BrowserDetect.version};