define("config/resolutions/scale", [
  ...
  function initProfile(base, target) {
    ...
    target.OUT_OF_SCREEN_ADJUSTMENT_TOP =
      base.OUT_OF_SCREEN_ADJUSTMENT_TOP * scale;
    target.OUT_OF_SCREEN_ADJUSTMENT_BOTTOM =
      base.OUT_OF_SCREEN_ADJUSTMENT_BOTTOM * scale;
    ...
    target.PUMP_POWER_RADIUS =
      target.PUMP_POWER_RADIUS || base.PUMP_POWER_RADIUS * scale;
    ...
    target.CANDY_BUBBLE_TUTORIAL_LIMIT_Y =
      base.CANDY_BUBBLE_TUTORIAL_LIMIT_Y * scale;
    target.CANDY_BUBBLE_TUTORIAL_LIMIT_X =
      base.CANDY_BUBBLE_TUTORIAL_LIMIT_X * scale;
