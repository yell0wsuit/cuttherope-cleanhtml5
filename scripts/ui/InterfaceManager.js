  ...
  var InterfaceManager = new (function () {
    ...
    var updateMiniSoundButton = function (doToggle, buttonId, msgId) {
      ...
      if (!isMusicOn && !isSoundOn) {
        ...
        var musicId = isMusicOn
            ? MenuStringId.MUSIC_ON
            : MenuStringId.MUSIC_OFF,
          soundId = isSoundOn
            ? MenuStringId.SOUNDS_ON
            : MenuStringId.SOUNDS_OFF,
    ...
    var onInitializePanel = function (panelId) {
        ...
        $("#playBtn").click(function () {
          ...
          VideoManager.playIntroVideo(function () {
            ...
            if (firstLevelStars === 0) {
              ...
              var panelId = edition.disableBoxMenu
                ? PanelId.LEVELS
                : PanelId.BOXES;
      ...
      // initialize the LEVELS panel
        ...
        PubSub.subscribe(
          PubSub.ChannelId.LanguageChanged,
          refreshOptionsButtons,
        );
        PubSub.subscribe(
          PubSub.ChannelId.ShowOptionsPage,
          refreshOptionsButtons,
        );
    ...
    var onShowPanel = function (panelId) {
      ...
      if (
        ...
        panelId == PanelId.BOXES ||
        panelId == PanelId.OPTIONS
      ) {
      ...
      //else if (panelId == PanelId.LEVELCOMPLETE) { }
        ...
        var gameWonText = Lang.menuText(
          MenuStringId.GAME_FINISHED_TEXT,
    ...
    this.showGameUI = function () {
      hideLevelBackground();
      if (
        QueryStrings.showBoxBackgrounds &&
        edition.enableBoxBackgroundEasterEgg
      ) {
        $("#bg").show();
      }
      $("#gameBtnTray").fadeIn();
