...
const locEntries = [
    ...
    },
    {
        ...
        fr: "Le cadeau de Noël fait une pause !",
        de: "Weihnachtsgeschenk macht eine Pause!",
        ru: "Праздничный подарок на перерыве!",
        ca: "El regal de vacances fa una pausa!",
        it: "Il regalo di Natale è in pausa!",
        nl: "Cadeau maakt een pauze!",
        br: "O presente de férias está fazendo uma pausa!",
        es: "¡El regalo de vacaciones está tomando un descanso!",
        zh: "节日礼物正在休息！",
        ja: "ホリデーギフトは 休憩中！",
        ko: "휴일 선물이 잠시 휴식을 취하고 있습니다!",
    },
    {
